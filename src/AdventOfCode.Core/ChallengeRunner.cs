...
namespace AdventOfCode.Core
{
    ...
    public class ChallengeRunner : IChallengeRunner
    {
        public void Run(int challengeId, string input, Assembly assembly)
        {
            ...
            {
                AnsiConsole.MarkupLine($"[red]No challenge with id '{challengeId}' could be found. Please verify the challenge has been implemented, and declares the correct id[/]");
                return;
            }
